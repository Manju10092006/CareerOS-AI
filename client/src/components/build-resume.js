...
(function() {
    ...
    // ============================================================
    const STORAGE_KEY = 'careerosai_build_resume_data';
    ...
    function saveResumeState() {
        ...
        localStorage.setItem('careerosai_has_used_builder', 'true');
    }
    
    function hasUsedBuilderBefore() {
        return localStorage.getItem('careerosai_has_used_builder') === 'true';
    }
